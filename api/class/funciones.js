...
// Ejemplo de uso 
console.log('Número de cuenta:', GeneradorDeDatosAleatorios.generarDígitosAleatorios(16));
console.log('Número de tarjeta de crédito:', GeneradorDeDatosAleatorios.generarNúmeroDeTarjetaDeCrédito());
console.log('CVV:', GeneradorDeDatosAleatorios.generarCVV());
console.log('Fecha de expiración:', GeneradorDeDatosAleatorios.generarFechaDeExpiración());